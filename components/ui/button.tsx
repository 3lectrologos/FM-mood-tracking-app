...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none shrink-0 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive',
  {
    variants: {
      variant: {
        default:
          'bg-blue-600 text-neutral-0 hover:bg-blue-700 disabled:bg-blue-200 outline-none focus-visible:ring-blue-700 focus-visible:ring-2 focus-visible:ring-offset-[3px]',
      },
      size: {
        default: 'px-400 py-150 rounded-10',
      },
    },
    defaultVariants: {
      variant: 'default',
